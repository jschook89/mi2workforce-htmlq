...
* Open with participant ids - If you send out unique links Easy HtmlQ will automatically fill in the participant id (uid). Use this format: [www.yourdomain.com/#/?userCode=USERCODE]() &nbsp;&nbsp;In the results file, the name given for USERCODE will show up in the UID field. 
