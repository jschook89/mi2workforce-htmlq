...
* Open with participant ids - If you send out unique links Easy HtmlQ will automatically fill in the participant id (uid). Use this format: <div style="display: inline">https://www.yourdomain.com/htmlq/#/?userCode=USERCODE</div>. In the results file, the user code will show up in the UID field. 
